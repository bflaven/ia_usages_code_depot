    ...
    if 'messages' not in st.session_state:
        ...
        with st.spinner("Fetching answer ..."):
            ...
            if text is not None:
                ...
                # Initialize the QA chain
                if 'qa_chain' not in st.session_state:
                    st.session_state.qa_chain = RetrievalQA.from_chain_type(llm_open, chain_type="stuff", retriever=knowledge_base.as_retriever(), chain_type_kwargs={"prompt": build_prompt("template_1")})
                ...
                if user_input := st.chat_input("You:", key="user_input"):
                    ...
                    with st.chat_message("assistant"):
                        with st.spinner("Assistant is typing..."):
                            ...
                            response = st.session_state.qa_chain({"query": st.session_state.transcript})
