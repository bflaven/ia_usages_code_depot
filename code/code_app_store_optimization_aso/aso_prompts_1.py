...
### 3. Add Keywords
# "aso_add_keywords" : """ 
# As an ASO (App Store Optimization) expert proficient, could you create a list of compelling application keywords for an 'iOS' mobile application in 'FRENCH' ? Please do follow these guidelines: 1. Incorporate primary keywords that users are likely to search for "{user_input}" 3. Ensure your brand name "FRANCE 24"
# """,
