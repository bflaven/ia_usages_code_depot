...
# LAUNCH the file
streamlit run 001_streamlit_app_store_optimization_aso.py
...
def main():
    ...
    with tab1:
        ...
        create_text_area("Description", "aso_optimization_app_description", 4000, "Texte changé très rarement")
        create_text_area("New Marketing Text", "aso_optimization_app_new_marketing_text", None, "Texte changé à chaque publication")
